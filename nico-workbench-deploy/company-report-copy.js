...
const selectedReportWeek=()=>text(document.querySelector('.selectedReportWeek')?.value||sessionStorage.getItem('nico_report_selected_week'));
const followersReminder=r=>text(r?.week)===selectedReportWeek()&&!followersRecorded(r);
